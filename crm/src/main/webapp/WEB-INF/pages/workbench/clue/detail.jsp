				...
				<table class="table table-hover" style="width: 900px;">
					...
					<c:forEach items="${activityList}" var="activity">
						<tr>
							...
							<td><a activityId="${activity.name}" href="javascript:void(0);"  style="text-decoration: none;"><span class="glyphicon glyphicon-remove"></span>解除关联</a></td>
						</tr>
					</c:forEach>
					</tbody>
				</table>
